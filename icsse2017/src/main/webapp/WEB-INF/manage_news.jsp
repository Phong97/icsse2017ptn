			...
			<div class="container">
				...
				<div class="collapse navbar-collapse" id="myNavbar">
					...
					<!-- check username  -->
				     ...
				     <%@ page import ="icsse2017.model.Account" %>
				     <% 
				     	//get username
			...
			<div class="row content" style="margin-left: 5px;margin-right: 5px;">
				...
				<div class="row manage_news">
					...
					<div class="col-sm-3 col-xs-3">
						<a href="add-news"><button class="addcandidate btn btn-primary btn">
								<span class="fa fa-plus-circle"> </span>Add News</button></a>
					</div>
			...
			<div class="row manage_news">
				...
				<div class="col-sm-10">
					...
					<div class="col-sm-6 col-xs-6 text-center">
						<button id="Confirm_info" class="btn btn-primary" type="submit" style="width: 100px">
					...
					<div class="col-sm-6 col-xs-6 text-center">
						<a href="manage_news"><button id="Reset_info" class="btn btn-danger">
				...
				<div class="col-sm-10">
					<div class="input-group">
						<span class="input-group-addon" id="basic-addon"> <i
							...
							class="form-control content_input" placeholder="Enter title"
							name="title" value="${news.title}" aria-describedby="basic-addon" required>
					</div>
				</div>
					<div class="khoangcach">
						<br> <br>
